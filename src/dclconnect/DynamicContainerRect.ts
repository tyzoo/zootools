 ...
 export class DynamicContainerRect implements ISystem{
    ...
    constructor(rect: UIContainerRect){
        ...
        this.defaultSettings = {
            width: new UIValue(rect.width),
            height: new UIValue(rect.height),
            positionX: new UIValue(rect.positionX),
            positionY: new UIValue(rect.positionY),
        }
     }
